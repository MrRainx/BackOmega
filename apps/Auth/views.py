...
from apps.Auth.models import Aplicacion, Permiso, Rol, Usuario
from apps.Auth import AplicacionSerializer, PermisoSerializer, GrupoSerializer, UsuarioSerializer
